// // months.js - generate months and aggregate monthly data
// export function getAllMonths(start, end) {
...
//     transactions[0]?.date.slice(0, 7) || "2026-01",
//     transactions[transactions.length - 1]?.date.slice(0, 7) || "2026-01"
//   );
...
export function aggregateMonthlyData(transactions) {
  ...
  // ✅ SORT INSIDE DATA MODULE (DO NOT REMOVE)
  ...
  allMonthDates.forEach(d => {
    ...
    if (monthMap[key]?.balance !== undefined) {
      lastBalance = monthMap[key].balance;
    }
